...
screenW, screenH = dgsGetScreenSize()

sWidth, sHeight = dgsGetScreenSize()
Auflosung_x = 1600
Auflosung_y = 900
...
addEventHandler("onClientResourceStart",resourceRoot,function()
	addCommandHandler("navi",function()
		local gps=dgsCreateImage(500*px,150*py,600*px,600*py,"images/gps.png",false)
		showCursor(true)
		setElementClicked ( false )
		addEventHandler("onDgsMouseClickUp",gps,function(button,state,absoluteX,absoluteY)
			if button=="left" then
				local mapposx,mapposy=dgsGetPosition(gps,true)
				local mapsizex,mapsizey=dgsGetSize(gps,true)
