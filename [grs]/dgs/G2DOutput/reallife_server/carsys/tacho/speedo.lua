...
function initGui()
    ...
    g_screenWidth, g_screenHeight = dgsGetScreenSize()
    local scale
    ...
    disc = dgsCreateImage(g_screenWidth - g_ImageW - g_XOffset, g_screenHeight - g_ImageH - g_YOffset, g_ImageW, g_ImageH, "images/disc.bmp", false)
	x, y = dgsGetPosition(disc, false)
	y = y + 40
	x = x - 15
