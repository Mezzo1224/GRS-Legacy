...
function dxdrawGangwarAnzeige ()
	...
	dxDrawText(gangwarKills, screenx-335*sxA, screeny-712*syA, screenx-380*sxA, screeny-700*syA,tocolor(255, 255, 255, 255), 1.6*sxA, "default-bold", "left", "top", false, false, true, false, false) -- Kill
	dxDrawText(math.floor(gangwarDamage), screenx-210*sxA, screeny-712*syA, screenx-380*sxA, screeny-700*syA,tocolor(255, 255, 255, 255), 1.6*sxA, "default-bold", "left", "top", false, false, true, false, false) -- DAMAGE
	dxDrawText(daminute..":"..dasekunde, screenx-120*sxA, screeny-712*syA, screenx-30*sxA, screeny-700*syA,tocolor(255, 255, 255, 255), 1.6*sxA, "default-bold", "center", "top", false, false, true, false, false) -- Time
	 
	dxDrawText(attackerfracname, screenx-400*sxA, screeny-667*syA, screenx-220*sxA, screeny-580*syA,tocolor(255, 255, 255, 255), 1.2*sxA, "default-bold", "center", "top", false, false, true, false, false) -- Attacker
	dxDrawText(attackeralive.." / "..attacker, screenx-400*sxA, screeny-647*syA, screenx-220*sxA, screeny-580*syA,tocolor(255, 255, 255, 255), 2*sxA, "default-bold", "center", "top", false, false, true, false, false) -- Attacker
	dxDrawText(defenderfracname, screenx-210*sxA, screeny-667*syA, screenx-30*sxA, screeny-580*syA,tocolor(255, 255, 255, 255), 1.2*sxA, "default-bold", "center", "top", false, false, true, false, false) -- DEFENDER
	dxDrawText(defenderalive.." / "..defender, screenx-210*sxA, screeny-647*syA, screenx-30*sxA, screeny-580*syA,tocolor(255, 255, 255, 255), 2*sxA, "default-bold", "center", "top", false, false, true, false, false) -- Attacker
	-- Distanz zum TK --
	if distance > reichweiteZumTK then
		distance = "Entfernung zum Totenkopf "..distance.."m"
		dxDrawText(distance,  screenx-120*sxA, screeny-608*syA, screenx-35, screeny-700*syA, tocolor(255, 0, 0, 255), 1*sxA, "default-bold", "right", "top", false, false)  -- DISTANCE ROT
	else
		distance = "Entfernung zum Totenkopf "..distance.."m"
		dxDrawText(distance,  screenx-120*sxA, screeny-608*syA, screenx-35, screeny-700*syA, tocolor(255, 255, 255, 255), 1*sxA, "default-bold", "right", "top", false, false)  -- DISTANCE Weiß
	end
	showing = true
end
