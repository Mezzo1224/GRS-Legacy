...
function joinAC130Gun ( camPos )
	...
	fireEnabled = true
	gImage["ac130Grey"] = dgsCreateImage ( 1, 1, screenwidth, screenheight, "images/colors/c_grey.jpg", false )
	dgsSetAlpha ( gImage["ac130Grey"], 0.3 )
	gImage["cross-hair"] = dgsCreateImage ( screenwidth / 2 - 200 /2, screenheight / 2 - 100 / 2, 200, 100, "images/cross-hair.png", false )
