...
function startHalloweenCamFlight ()
	...
	dgsSetEnabled ( damageImage, true )
	dgsSetAlpha ( damageImage, 1 )
	loadHalloweenSkins ()
	setWeather ( 9 )
	setTime ( 1, 0 )
...
function stopHalloweenCamFlight ()
	...
	dgsSetEnabled ( damageImage, false )
	dgsSetAlpha ( damageImage, 0 )
...
function createHalloweenGUI ( )
	...
	if isHalloween then
		...
		gWindow["halloweenMenue"] = dgsCreateWindow( windowx, windowy, 627, 221, "Halloween-Boni", false )
		gHalloweenButton[1] = dgsCreateButton( 10, 25, 147, 65, "Suessigkeiten\nfuer 10 Kuerbisse", false, gWindow["halloweenMenue"] )
		gHalloweenButton[2] = dgsCreateButton( 10, 95, 147, 65, "'Sensenmann' fuer 100 Kuerbisse", false, gWindow["halloweenMenue"] )
		gHalloweenButton[3] = dgsCreateButton( 162, 25, 147, 65, "10.000$\nfuer 250 Kuerbisse", false, gWindow["halloweenMenue"] )
		gHalloweenButton[4] = dgsCreateButton( 162, 95, 147, 65, "Kopflos-Munition\nfuer 150 Kuerbisse", false, gWindow["halloweenMenue"] )
		gHalloweenButton[5] = dgsCreateButton( 314, 25, 147, 65, "Auto-Gutschein\nfuer 1200 Kuerbisse", false, gWindow["halloweenMenue"] )
		gHalloweenButton[6] = dgsCreateButton( 314, 95, 147, 65, "Turismo\nfuer 2000 Kuerbisse", false, gWindow["halloweenMenue"] )
		gHalloweenButton[7] = dgsCreateButton( 467, 25, 147, 65, "Hotring\nfuer 5000 Kuerbisse", false, gWindow["halloweenMenue"] )
		gHalloweenButton[8] = dgsCreateButton( 467, 95, 147, 65, "Hausmarker\nfuer 10000 Kuerbisse", false, gWindow["halloweenMenue"] )
		gHalloweenButton[9] = dgsCreateButton( (627/2-239/2), 160, 239, 48, "Abbrechen", false, gWindow["halloweenMenue"] )
		
		addEventHandler ( "onDgsMouseClickUp", gHalloweenButton[9],
			function ( )
				closeHalloweenGUI ( )
			end, false )
			
		addEventHandler ( "onDgsMouseClickUp", gHalloweenButton[1],
			function ( )
				closeHalloweenGUI ( )
				triggerServerEvent ( "buyEasterBonus", lp, "suess" )
			end, false )
			
		addEventHandler ( "onDgsMouseClickUp", gHalloweenButton[2],
			function ( )
				closeHalloweenGUI ( )
				triggerServerEvent ( "buyEasterBonus", lp, "state" )
			end, false )
			
		addEventHandler ( "onDgsMouseClickUp", gHalloweenButton[3],
			function ( )
				closeHalloweenGUI ( )
				triggerServerEvent ( "buyEasterBonus", lp, "dollar" )
			end, false )
			
		addEventHandler ( "onDgsMouseClickUp", gHalloweenButton[4],
			function ( )
				closeHalloweenGUI ( )
				triggerServerEvent ( "buyEasterBonus", lp, "munni" )
			end, false )
			
		addEventHandler ( "onDgsMouseClickUp", gHalloweenButton[5],
			function ( )
				closeHalloweenGUI ( )
				triggerServerEvent ( "buyEasterBonus", lp, "gutschein" )
			end, false )
			
		addEventHandler ( "onDgsMouseClickUp", gHalloweenButton[6],
			function ( )
				closeHalloweenGUI ( )
				triggerServerEvent ( "buyEasterBonus", lp, "turismo" )
			end, false )
			
		addEventHandler ( "onDgsMouseClickUp", gHalloweenButton[7],
			function ( )
				closeHalloweenGUI ( )
				triggerServerEvent ( "buyEasterBonus", lp, "ht b" )
			end, false )
			
		addEventHandler ( "onDgsMouseClickUp", gHalloweenButton[8],
			function ( )
				closeHalloweenGUI ( )
