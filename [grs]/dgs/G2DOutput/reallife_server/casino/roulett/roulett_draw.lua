...
function getNewRoulettDrawNumber ( number )
	...
	gImage["roulettBasicBG"] = dgsCreateImage ( screenwidth/2-roulettRandomFieldSizeX/2, 0, roulettRandomFieldSizeX, roulettRandomFieldSizeY, "images/colors/c_"..color..".jpg", false )
end

function showRoulettWinningNumber_func ( finalNumber, total )

	if finalNumber then
		gImage["roulettBasicBorder1"] = dgsCreateImage ( screenwidth/2-roulettRandomFieldSizeX/2 - 5, 0, 5, roulettRandomFieldSizeY, "images/colors/c_grey.jpg", false )
		gImage["roulettBasicBorder2"] = dgsCreateImage ( screenwidth/2+roulettRandomFieldSizeX/2, 0, 5, roulettRandomFieldSizeY, "images/colors/c_grey.jpg", false )
		gImage["roulettBasicBorder3"] = dgsCreateImage ( screenwidth/2+roulettRandomFieldSizeX/2 - roulettRandomFieldSizeX - 5, roulettRandomFieldSizeY, roulettRandomFieldSizeX + 10, 5, "images/colors/c_grey.jpg", false )
