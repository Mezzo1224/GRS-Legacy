...
function showSpawnSelection ()
	...
	if isElement ( gWindow["spawnPointSelection"] ) then
		...
		gWindow["spawnPointSelection"] = dgsCreateWindow(screenwidth/2-281/2,120,281,287,"Startpunkt",false)
		dgsSetAlpha(gWindow["spawnPointSelection"],1)
		gGrid["availableSpawnPoints"] = dgsCreateGridList(9,25,128,253,false,gWindow["spawnPointSelection"])
		dgsGridListSetSelectionMode(gGrid["availableSpawnPoints"],2)
		...
		gButton["changeSpawnPoint"] = dgsCreateButton(145,100,126,69,"Als Start- und\nWieder-\neinstiegspunkt festlegen",false,gWindow["spawnPointSelection"])
		dgsSetAlpha(gButton["changeSpawnPoint"],1)
		dgsSetFont(gButton["changeSpawnPoint"],"default-bold-small")
