...
function showJobGUI()
	...
	if gWindow["jobs"] then
		...
		gWindow["jobs"] = dgsCreateWindow(screenwidth/2-451/2,screenheight/2-383/2,451,383,"Jobcenter",false)
		dgsSetAlpha(gWindow["jobs"],1)
		gImage["jobStar"] = dgsCreateImage(9,38,38,31,"images/internet/star.png",false,gWindow["jobs"])
		dgsSetAlpha(gImage["jobStar"],1)
		...
		dgsSetAlpha(gLabel["jobText1"],1)
		dgsLabelSetColor(gLabel["jobText1"],200,000,0)
		dgsLabelSetVerticalAlign(gLabel["jobText1"],"top")
		dgsLabelSetHorizontalAlign(gLabel["jobText1"],"left",false)
		dgsSetFont(gLabel["jobText1"],"default-bold-small")
		...
		dgsSetAlpha(gGrid["joblist"],1)
		gLabel["jobText2"] = dgsCreateLabel(190,101,258,225,"Bitte waehle einen Job aus der Liste aus!",false,gWindow["jobs"])
		dgsSetAlpha(gLabel["jobText2"],1)
		dgsLabelSetColor(gLabel["jobText2"],255,255,255)
		dgsLabelSetVerticalAlign(gLabel["jobText2"],"top")
		dgsLabelSetHorizontalAlign(gLabel["jobText2"],"left",false)
		dgsSetFont(gLabel["jobText2"],"default-bold-small")
		gButtons["jobanzeigen"] = dgsCreateButton(264,328,95,45,"Position anzeigen",false,gWindow["jobs"])
		dgsSetAlpha(gButtons["jobanzeigen"],1)
		dgsSetFont(gButtons["jobanzeigen"],"default-bold-small")
		gButtons["jobcancel"] = dgsCreateButton(424,26,15,17,"x",false,gWindow["jobs"])
		dgsSetAlpha(gButtons["jobcancel"],1)
