...
function showBarInterface ()
	...
	if gWindow["bar"] then
		...
		gWindow["bar"] = dgsCreateWindow(screenwidth/2-247/2,screenheight/2-221/2,247,221,"Bar",false)
		dgsWindowSetMovable ( gWindow["bar"], false )
		dgsWindowSetSizable ( gWindow["bar"], false )
		dgsSetAlpha ( gWindow["bar"], 1 )
		
		gGrid["barDrinks"] = dgsCreateGridList(9,28,134,179,false,gWindow["bar"])
		...
		gImage[1] = dgsCreateImage(103,112,30,63,"images/gui/bottle.png",false,gGrid["barDrinks"])
		dgsSetAlpha(gImage[1],0.7)
		
		gLabel[1] = dgsCreateLabel(149,27,93,19,"Was darfs sein?",false,gWindow["bar"])
		...
		gButton["barDrink"] = dgsCreateButton(160,50,72,43,"Trinken",false,gWindow["bar"])
		gButton["barSnack"] = dgsCreateButton(160,104,72,43,"Snack\nkaufen",false,gWindow["bar"])
		gButton["barClose"] = dgsCreateButton(160,159,72,43,"Schliessen",false,gWindow["bar"])
