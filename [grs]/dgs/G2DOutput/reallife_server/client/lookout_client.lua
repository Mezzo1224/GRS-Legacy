...
function lookoutImage ( show )
	...
	if show then
		...
		viewingNow = true
		gImage["lookout1"] = dgsCreateImage ( lookoutIMGX, lookoutIMGY, lookoutIMGWidth, lookoutIMGHeight, path, false, nil )
		
		-- Oben --
		gImage["lookout2"] = dgsCreateImage ( 0, 0, screenwidth, lookoutIMGY, bPath, false, nil )
		-- Unten --
		gImage["lookout3"] = dgsCreateImage ( 0, lookoutIMGY + lookoutIMGHeight - 1, screenwidth, lookoutIMGY + 1, bPath, false, nil )
		-- Links --
		gImage["lookout4"] = dgsCreateImage ( 0, lookoutIMGY, lookoutIMGX, screenwidth, bPath, false, nil )
		-- Rechts --
		gImage["lookout5"] = dgsCreateImage ( lookoutIMGX + lookoutIMGWidth, lookoutIMGY, lookoutIMGX, screenwidth, bPath, false, nil )
	else
