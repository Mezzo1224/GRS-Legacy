...
function lookGlass ()
	...
	if not spyGoglesActive and not getElementClicked () and vioClientGetElementData ( "fglass" ) then
		...
		gImage["spyGogles"] = dgsCreateImage ( 0, 0, 1, 1, "images/lookout.png", true )
		gImage["spyGoglesRedDot"] = dgsCreateImage ( screenwidth / 2 - 2, screenheight / 2 - 2, 4, 4, "images/reddot.png", false )
	end
end
