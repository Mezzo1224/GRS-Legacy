...
--[[function showInfoText_func ()
	...
	if not gLabels["InfoTextForum"] then
		gLabels["InfoTextForumShadow"] = dgsCreateLabel(10, screenheight-20+1, screenwidth+1, screenheight,"Forum: "..forumURL..", Hilfemenue: F1, Karte: F11",false)
		gLabels["InfoTextForum"] = dgsCreateLabel(10, screenheight-20, screenwidth, screenheight,"Forum: "..forumURL..", Hilfemenue: F1, Karte: F11",false)
		dgsLabelSetColor(gLabels["InfoTextForum"],125,20,20)
		dgsLabelSetColor(gLabels["InfoTextForumShadow"],0,0,0)
		dgsSetFont(gLabels["InfoTextForum"],"default-bold-small")
		dgsSetFont(gLabels["InfoTextForumShadow"],"default-bold-small")
	end
end
...
if noInfobox == false then
	...
	if isTimer ( ChatBoxTimer1 ) then
		...
		infoboxIMG = dgsCreateImage(x/2-140,5,280,160,"images/black.png",false)
		dgsSetAlpha(infoboxIMG, 0.95)
	end
...
if noInfobox == false then
	...
	infoboxText = dgsCreateImage ( x/2-150, 5, 280, 160, "images/black.png", false )
	infoboxTextLabel = dgsCreateLabel ( 10,10,122,78,"", false )
	dgsLabelSetColor ( infoboxTextLabel, 255, 255, 125 )
	dgsSetAlpha ( infoboxText, 1 )
	dgsSetAlpha ( infoboxTextLabel, 1 )
	dgsSetVisible(infoboxText, false)
	dgsSetVisible(infoboxTextLabel, false)
	dgsSetFont ( infoboxTextLabel, "default-bold-small" )
	end
end
