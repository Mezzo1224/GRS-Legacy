...
function betaWarning ()
    if getSetting (22) == 1  then
        ...
        dxDrawText(SharedConfig["main"].serverName.." Pre-Release -  "..SharedConfig["main"].version.." - Bugs in Discord melden, alles WIP", 899*sx, 0*sy, 1662*sx, 38*sy, tocolor(255, 255, 255, 255), FrontSize, "default", "left", "top", false, false, false, false, false)
    end
end
