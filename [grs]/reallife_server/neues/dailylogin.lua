...
function getBoni (player, login)
	if login == 1 then
		...
		if reward >= 25 then
			vioSetElementData ( player, "bankmoney", vioGetElementData ( player, "bankmoney") + math.floor(500/2) )
		else
			vioSetElementData ( player, "bankmoney", vioGetElementData ( player, "bankmoney") +  math.floor(1000/2) )
		end
	elseif login == 2 then
		local reward = math.random(1,100)
		if reward >= 25 then
			...
			vioSetElementData ( player, "bankmoney", vioGetElementData ( player, "bankmoney") +  math.floor(1500/2) )
		end
	elseif login == 3 then
		local reward = math.random(1,100)
		if reward >= 25 then
		...
		elseif reward <= 10 and reward > 5 then
			vioSetElementData ( player, "bankmoney", vioGetElementData ( player, "bankmoney") +  math.floor(2000/2) )
		elseif reward < 5 then
			vioSetElementData ( player, "bankmoney", vioGetElementData ( player, "bankmoney") +  math.floor(3000/2) )
		end
	elseif login == 4 then
		local reward = math.random(1,100)
		if reward >= 25 then
			vioSetElementData ( player, "bankmoney", vioGetElementData ( player, "bankmoney") +  math.floor(2000/2) )
		elseif reward <= 10 and reward > 5 then
			vioSetElementData ( player, "bankmoney", vioGetElementData ( player, "bankmoney") +  math.floor(2500/2) )
		elseif reward < 5 then
			vioSetElementData ( player, "bankmoney", vioGetElementData ( player, "bankmoney") +  math.floor(4000/2) )
		end
	elseif login == 5 then
		local reward = math.random(1,100)
		if reward >= 25 then
		...
		elseif reward <= 10 and reward > 5 then
			vioSetElementData ( player, "bankmoney", vioGetElementData ( player, "bankmoney") +  math.floor(3000/2) )
		elseif reward < 5 then
			vioSetElementData ( player, "bankmoney", vioGetElementData ( player, "bankmoney") +  math.floor(5000/2) )
		end
	elseif login == 6 then
		local reward = math.random(1,100)
		if reward <= 10 then
			...
			vioSetElementData ( player, "bankmoney", vioGetElementData ( player, "bankmoney") +  math.floor(6000/2) )
		end
	end
end
