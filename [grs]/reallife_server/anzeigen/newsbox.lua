...
function DevModeNews()
    outputChatBox ( "!! Der Devmode Stufe "..devmode.." ist aktiviert !!", root, 200, 200, 0 )
   outputChatBox ( "!! Der Livebetrieb sollte nicht stattfinden sein !!", root, 200, 200, 0 )
end

if devmode > 0 then 
   setTimer ( DevModeNews, 120000 , 0 )
   DevModeNews()
end
