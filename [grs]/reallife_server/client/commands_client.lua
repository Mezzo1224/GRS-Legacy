...
addCommandHandler ( "commands", function ( cmd, typ )
	if typ then
		if allCommands[typ] then
			...
			outputChatBox ( "handy, drogen, reporter, sonstiges, haus, club, schuss, unternehmen, gangaktion, chat, prestige, biz", 255, 0, 0 )
		end
	else
		outputChatBox ( "Gebrauch: /commands  [Kategorie]", 255, 0, 0 ) 
		outputChatBox ( "Möglich: account, fahrzeug, admin, polizei, spiele, job, taxi, mechaniker, mats, tramjob", 255, 0, 0 )
		outputChatBox ( "handy, drogen, reporter, sonstiges, haus, club, schuss, unternehmen, gang,aktion, chat, prestige, biz", 255, 0, 0 )
	end
end )
