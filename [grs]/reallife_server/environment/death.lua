...
function playerdeath ( killer, weapon, part )
	...
	if vioGetElementData ( player, "Tode" ) >= 1 then
...
function endfade ( player, timeToBeDeath )
	...
	if isElement ( player ) then
		removePedFromVehicle ( player )
		triggerClientEvent ( player, "infobox_start", getRootElement(), "Du bist außer Gefecht.\nDu wirst nun behandelt.", 7500, 125, 0, 0 )
