...
function teamchat_func ( player, cmd, ... )	
	...
	elseif coopID > 0 then
		print(cooperation[coopID].name) 
		print(cooperationRanks[coopID][coopRang])
		sendMessageToCooperation ( "["..cooperation[coopID].name.."- "..cooperationRanks[coopID][coopRang].."] "..getPlayerName ( player )..": "..text , coopID  )
	else
