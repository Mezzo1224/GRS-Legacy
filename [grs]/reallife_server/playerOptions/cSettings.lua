...
local clientSettings = {
    ...
    { id = 13, name = "Autologin", description = "Stellt ein, ob du automatisch Eingeloggt werden willst. Benötigt 'Passwort speichern' ", defaultValue = false, type = "boolean", category = "Account"  },
    { id = 14, name = "Passwort Speichern", description = "Stellt ein, ob das Passwort beim Login gespeichert werden soll. ", defaultValue = false, type = "boolean", category = "Account"  },
}
...
function createClientSettingsFile(player)
    ...
    local fileName = ":grs_cache/client_settings_" .. playerName .. ".json"
