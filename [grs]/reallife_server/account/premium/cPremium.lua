...
function showVehicleTokenInfo (nextDate, currentRank)
    if not getElementClicked() then
        ...
        vehTokenUI["image"] = DGS:dgsCreateImage(119, 20, 61, 68, "/images/premium/vehicle.png", false,vehTokenUI["window"])
        ...
        vehTokenUI["how"] = DGS:dgsCreateLabel(10, 209, 284, 20, "'/self' -> 'Einstellungen' -> 'VIP-Funktionen' ", false, vehTokenUI["window"])
        vehTokenUI["whenTitle"] = DGS:dgsCreateLabel(10, 223, 279, 20, "Wann erhalte ich meinen nächsten Token ?", false, vehTokenUI["window"])
        vehTokenUI["when"] = DGS:dgsCreateLabel(10, 243, 284, 47, "Sollte dein Premium-Rang bestehen bleiben, ist es der "..nextDate..". Wir wünschen dir viel Spaß mit deinem neuen Fahrzeug!", false, vehTokenUI["window"])
...
addEvent ( "showVehicleTokenInfo", true )
addEventHandler ( "showVehicleTokenInfo", getRootElement(), showVehicleTokenInfo)
